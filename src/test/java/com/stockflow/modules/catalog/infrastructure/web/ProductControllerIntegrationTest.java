 ...
 *
 * <p>
 * Tests the complete product CRUD operations:
 * </p>
 * <ul>
...
@Transactional
class ProductControllerIntegrationTest extends H2IntegrationTest {
        ...
        void setUp() throws Exception {
                ...
                Tenant tenant = tenantRepository
                                .save(new Tenant("Test Tenant", "test-tenant-product-" + System.currentTimeMillis()));
