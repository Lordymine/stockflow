 ...
 *
 * <p>
 * Tests the complete inventory management:
 * </p>
 * <ul>
...
@Transactional
class InventoryControllerIntegrationTest extends H2IntegrationTest {
        ...
        void setUp() throws Exception {
                ...
                Tenant tenant = tenantRepository
                                .save(new Tenant("Test Tenant", "test-tenant-" + System.currentTimeMillis()));
