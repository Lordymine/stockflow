 ...
 *
 * <p>This class wraps user information extracted from the JWT token and provides
 * the security context with the necessary authentication and authorization data.</p>
 *
 * <p>Unlike the default UserDetailsService implementation, this is a lightweight
 * wrapper that doesn't require database access on every request.</p>
 */
